...
{
    public ClotController(MagicController spell1, MagicController spell2, MagicController spell3, MagicEffect effect, GameObject prefab, string formModif) : base(spell1, spell2, spell3, effect, formModif)
    {
        spellPrefab = prefab;
    }
