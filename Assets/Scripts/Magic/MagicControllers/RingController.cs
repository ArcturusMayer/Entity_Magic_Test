...
{
    public RingController(MagicController spell1, MagicController spell2, MagicController spell3, MagicEffect effect, GameObject prefab) : base(spell1, spell2, spell3, effect)
    {
        spellPrefab = prefab;
    }
